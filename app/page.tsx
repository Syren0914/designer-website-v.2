      ...
      <section className="pt-32 pb-20 px-4 md:px-8 container mx-auto">
        <div className="grid grid-cols-12 gap-4">
          ...
          <div className="col-span-12 md:col-span-5 flex items-center justify-center">
            ...
            <Image src={"/side.jpg"} alt={""} width={600} height={600}></Image>
          ...
          <div className="grid grid-cols-12 gap-8">
            <div className="col-span-12 md:col-span-5">
              ...
              <div className="aspect-[4/5] bg-neutral-100 relative mb-8 md:mb-0">
                <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/4 h-3/4 border-2 border-black">
                  <Image src={"/black.jpg"} alt={""} width={600} height={600}></Image>
                </div>
              </div>
            </div>
